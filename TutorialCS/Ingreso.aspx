<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Ingreso.aspx.cs" Inherits="Edit" Culture="es-CL" %>
        ...
        <table border="0" cellspacing="4" cellpadding="0">
            <tr>
                ...
                <td>
                    ...
                    OnClientClick="return confirm('¿Confirma que desea eliminar la reserva?');">Eliminar</asp:LinkButton>
                    <br />
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td><asp:Label ID="lblobs" runat="server" Text="Label">Detalle:</asp:Label></td>
