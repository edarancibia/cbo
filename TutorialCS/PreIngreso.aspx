<%@ Page Language="C#" AutoEventWireup="true"  CodeFile="PreIngreso.aspx.cs" Inherits="_Default" MasterPageFile="~/MasterPage2.master" Title="Gestión camas CBO-PreIngresos" Culture="es-CL"%>
...
<asp:Content ID="HeaderContent" runat="server" ContentPlaceHolderID="HeadContent">
	...
	<script type="text/javascript">
	    ...
	    function createEvent(start, end, resource) {
	        modal.height = 250;
	        modal.showUrl("PreIngresoPac.aspx?start=" + start.toStringSortable() + "&end=" + end.toStringSortable() + "&r=" + resource);
	    }

	    function editEvent(id) {
            modal.height = 300;
	        modal.showUrl("PreIngresoPacEdita.aspx?id=" + id);
	    }
