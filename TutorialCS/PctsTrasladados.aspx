<%@ Page Language="C#" AutoEventWireup="true"  CodeFile="PctsTrasladados.aspx.cs" Inherits="_Default" MasterPageFile="~/MasterPage2.master" Title="Gestión camas CBO-Ingresos" Culture="es-CL"%>
	...
	<script type="text/javascript">
	   ...
	   /* function createEvent(start, end, resource) {
	    ...
	    function editEvent(id) {
	        modal.height = 300;
	        modal.showUrl("IngresoTraslado.aspx?id=" + id);
	    }
...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
    ...
    <DayPilot:DayPilotScheduler 
        ...
        >
        <HeaderColumns>
            <DayPilot:RowHeaderColumn Title="CAMA ORIGEN" Width="80" />
