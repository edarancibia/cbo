...
public partial class RPT_CD_OBST : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            ReportViewer1.LocalReport.ReportPath = "Reportes/RCD_OBST.rdlc";
    ...
    private DataTable getReport()
    {
        ...
        try
        {
            SqlCommand cmd = new SqlCommand("HOS_RPT_CD_OBST_EXISTENCIA", con);
    ...
    private DataTable getReport2()
    {
        ...
        try
        {
            SqlCommand cmd = new SqlCommand("HOS_RPT_CD_OBST_URGENCIA", con);
            cmd.CommandType = CommandType.StoredProcedure;
    ...
    private DataTable getReport3()
    {
        ...
        try
        {
            SqlCommand cmd = new SqlCommand("HOS_RPT_CD_OBST_FUERA", con);
            cmd.CommandType = CommandType.StoredProcedure;
    ...
    private DataTable getReport4()
    {
        ...
        try
        {
            SqlCommand cmd = new SqlCommand("HOS_RPT_CD_OBST_TRASLADODE", con);
            cmd.CommandType = CommandType.StoredProcedure;
    ...
    private DataTable getReport5()
    {
        ...
        try
        {
            SqlCommand cmd = new SqlCommand("HOS_RPT_CD_OBST_TRASLADOA", con);
            cmd.CommandType = CommandType.StoredProcedure;
    ...
    private DataTable getReport6()
    {
        ...
        try
        {
            SqlCommand cmd = new SqlCommand("HOS_RPT_CD_OBST_VIVOS", con);
            cmd.CommandType = CommandType.StoredProcedure;
    ...
    private DataTable getReport7()
    {
        ...
        try
        {
            SqlCommand cmd = new SqlCommand("HOS_RPT_CD_OBST_FALLECIDOS", con);
            cmd.CommandType = CommandType.StoredProcedure;
    ...
    private DataTable getReport8()
    {
        ...
        try
        {
            SqlCommand cmd = new SqlCommand("HOS_RPT_CD_OBST_MISMODIA", con);
            cmd.CommandType = CommandType.StoredProcedure;
    ...
    private DataTable getReport9()
    {
        ...
        try
        {
            SqlCommand cmd = new SqlCommand("HOS_RPT_CD_OBST_DISPONIBLES", con);
            cmd.CommandType = CommandType.StoredProcedure;
