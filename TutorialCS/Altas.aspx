<%@ Page Language="C#" AutoEventWireup="true"  CodeFile="Altas.aspx.cs" Inherits="_Default" MasterPageFile="~/MasterPage2.master" Title="Gestión camas CBO-Altas" Culture="es-CL"%>
...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
    ...
    SECTOR:
        ...
        <asp:ListItem Text="UPC" Value="4"></asp:ListItem>
         ...
         &nbsp&nbsp&nbsp&nbsp 
        <asp:LinkButton ID="LinkButton1" runat="server" PostBackUrl="~/ListaAltas.aspx">Lista de altas</asp:LinkButton>
