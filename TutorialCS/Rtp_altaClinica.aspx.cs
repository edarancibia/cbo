...
public partial class Rtp_altaClinica : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        int ficha = Convert.ToInt32(Session["ficha3"]);
        TextBox1.Visible = false;
        TextBox1.Text = ficha.ToString();
        DataTable dt = getReport();/*
        ReportViewer1.LocalReport.ReportPath = "Reportes/alta.rdlc";
    ...
    private DataTable getReport()
    {
        ...
        try
        {
            SqlCommand cmd = new SqlCommand("HOS_ETIQUETA", con);
            cmd.CommandType = CommandType.StoredProcedure;
            cmd.Parameters.AddWithValue("FICHA",Convert.ToInt32(TextBox1.Text));
