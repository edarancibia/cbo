<%@ Page Language="C#" AutoEventWireup="true"  CodeFile="Hospitalizacion.aspx.cs" Inherits="_Default" MasterPageFile="~/MasterPage2.master" Title="Gestión camas CBO-Ingresos" Culture="es-CL"%>
...
<asp:Content ID="HeaderContent" runat="server" ContentPlaceHolderID="HeadContent">
	...
	<script type="text/javascript">
	    ...
	    function editEvent(id, ID_ESTADOCAMA) {
	        modal.height = 300;
	        modal.showUrl("Ingreso.aspx?id=" + id);
	    }
...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
    <br />
    <h2>Ingresos a hospitalización</h2>
