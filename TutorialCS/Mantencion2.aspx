<%@ Page Language="C#" AutoEventWireup="true"  CodeFile="Mantencion2.aspx.cs" Inherits="_Default" MasterPageFile="~/Site.master" Title="Gestión camas CBO" Culture="es-CL"%>
...
<asp:Content ID="HeaderContent" runat="server" ContentPlaceHolderID="HeadContent">
	...
	<script type="text/javascript">
	    ...
	    function createEvent(start, end, resource) {
	        modal.height = 250;
	        modal.showUrl("NuevaMantencion.aspx?start=" + start.toStringSortable() + "&end=" + end.toStringSortable() + "&r=" + resource);
	    }
...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
    <br />
    <h2>Planificar mantenciones</h2>
    <div style="margin-bottom: 5px;">
    SECTOR:
        <asp:DropDownList ID="cbosector" runat="server" onchange="filter('room', this.value)">
        ...
        <asp:Label ID="lblocupa" runat="server" Text="Label" Font-Size="Medium" ForeColor="Blue" Font-Bold="True"></asp:Label>
    ...
    <DayPilot:DayPilotScheduler 
        ...
        <HeaderColumns>
            ...
            <DayPilot:RowHeaderColumn Title="ESTADO ACTUAL" Width="120" />
